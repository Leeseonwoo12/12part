...
class ViewController: UIViewController, AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    func selectAudioFile() {
        if !isRecordMode {
            ...
            audioFile = documentDirectory.description.appendingPathComponent("recordFile.m4a")
        }
    }
    ...
    @IBAction func slChangeVoiume(_ sender: UISlider) {
        audioPlayer.volume = slVolume.value
    }
